...
// getUserID return a user by id
func (m *postgresDBRepo) GetUserByID(id int) (models.User, error) {
	ctx, cancel := context.WithTimeout(context.Background(), 3*time.Second)
	defer cancel()

	query := `select id, first_name, last_name, email, password,access_level,created_at,updates_at
...
// UpdateUser update a user in the data base
...
// AllReservation returns a slice of all reservation
...
// AllNewReservation returns a slice of all reservation
